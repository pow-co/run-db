...
export default class Database {
  ...
  static HEIGHT_MEMPOOL: number = -1;
  static HEIGHT_UNKNOWN: number;
  ...
  logger: any;
  path: string;
  db: typeof Sqlite3Database;
  readonly: boolean;

  
  getAllUnspentByClassLockScripthashStmt: SqliteStatement;
    addNewTransactionStmt: SqliteStatement;
    setTransactionBytesStmt: SqliteStatement
    setTransactionExecutableStmt: SqliteStatement
    getTransactionExecutableStmt: SqliteStatement
    setTransactionTimeStmt: SqliteStatement
    setTransactionHeightStmt: SqliteStatement
    setTransactionHasCodeStmt: SqliteStatement
    setTransactionExecutedStmt: SqliteStatement
    setTransactionIndexedStmt: SqliteStatement
    hasTransactionStmt: SqliteStatement
    getTransactionHexStmt: SqliteStatement
    getTransactionTimeStmt: SqliteStatement
    getTransactionHeightStmt: SqliteStatement
    getTransactionHasCodeStmt: SqliteStatement
    getTransactionIndexedStmt: SqliteStatement
    getTransactionFailedStmt: SqliteStatement
    getTransactionDownloadedStmt: SqliteStatement
    deleteTransactionStmt: SqliteStatement
    unconfirmTransactionStmt: SqliteStatement
    getTransactionsAboveHeightStmt: SqliteStatement
    getMempoolTransactionsBeforeTimeStmt: SqliteStatement
    getTransactionsToDownloadStmt: SqliteStatement
    getTransactionsDownloadedCountStmt: SqliteStatement
    getTransactionsIndexedCountStmt: SqliteStatement
    isReadyToExecuteStmt: SqliteStatement
    getDownstreamReadyToExecuteStmt: SqliteStatement
    setSpendStmt: SqliteStatement
    setUnspentStmt: SqliteStatement
    getSpendStmt: SqliteStatement
    unspendOutputsStmt: SqliteStatement
    deleteSpendsStmt: SqliteStatement
    addDepStmt: SqliteStatement
    deleteDepsStmt: SqliteStatement
    getDownstreamStmt: SqliteStatement
    getUpstreamUnexecutedCodeStmt: SqliteStatement 
    getUpstreamStmt: SqliteStatement
    setJigStateStmt: SqliteStatement
    setJigClassStmt: SqliteStatement
    setJigLockStmt: SqliteStatement
    setJigScripthashStmt: SqliteStatement
    getJigStateStmt: SqliteStatement
    deleteJigStatesStmt: SqliteStatement;
    getAllUnspentStmt: SqliteStatement;
    getAllUnspentByClassStmt: SqliteStatement;
    getAllUnspentByLockStmt: SqliteStatement;
    getAllUnspentByScripthashStmt: SqliteStatement;
    getAllUnspentByClassLockStmt: SqliteStatement;
    getAllUnspentByClassScripthashStmt: SqliteStatement;
    getAllUnspentByLockScripthashStmt: SqliteStatement;
    getAllUnspentByClassLockScripthashS: SqliteStatement;tmt
    getNumUnspentStmt: SqliteStatement;
    setBerryStateStmt: SqliteStatement;
    getBerryStateStmt: SqliteStatement;
    deleteBerryStatesStmt: SqliteStatement;
    setTrustedStmt: SqliteStatement;
    getTrustlistStmt: SqliteStatement;
    isTrustedStmt: SqliteStatement;
    banStmt: SqliteStatement;
    unbanStmt: SqliteStatement;
    isBannedStmt: SqliteStatement;
    getBanlistStmt: SqliteStatement;
    getHeightStmt: SqliteStatement;
    getHashStmt: SqliteStatement;
    setHeightStmt: SqliteStatement;
    setHashStmt: SqliteStatement;
    markExecutingStmt: SqliteStatement;
    unmarkExecutingStmt: SqliteStatement;
   

  constructor (path: string, logger, readonly = false) {
    this.path = path
    this.logger = logger
    this.db = null
